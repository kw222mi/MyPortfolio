...
export const CircularText = ({ className, ...rest }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="300" // Ändrat till mindre bredd
    height="300" // Ändrat till mindre höjd
    viewBox="0 0 300 300" // Ändrat till mindre storlek för att matcha den nya radien
    className={`w-full h-auto ${className}`}
    {...rest}
  >
    {/* Definiera en mindre cirkulär bana */}
    <defs>
      <path
        id="circlePath"
        d="M150,150 m-100,0 a100,100 0 1,1 200,0 a100,100 0 1,1 -200,0" // Ändrat radien till 100
      />
    </defs>
