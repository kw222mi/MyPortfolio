          ...
          <div className="grid w-full grid-cols-8 gap-16">
            <div className="col-span-3 flex flex-col items-start justify-start">
              ...
              <p className="font-medium">
                <b>Tech Mastery: </b>
                Proficient in JavaScript, with a focus on React.js, I wield the
                power of Express.js, Node.js, and MongoDB in the backend. From
                crafting stylish user interfaces with HTML, CSS, and Tailwind to
                securing APIs with JWT, my technical toolkit is robust and
                versatile.
                <br />
                <br />
                <b>Proven Performance: </b> Despite being a recent graduate from
                Linné University, my portfolio boasts impactful projects
                showcasing my knack for problem-solving and collaborative
                teamwork.
                <br />
                <br />
                <b>Beyond Coding: </b>
