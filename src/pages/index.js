          ...
          <div className="flex items-center justify-between w-full">
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <p className="my-4 text-base font-medium">
                Hello there! I&apos;m a passionate full-stack developer on a
                mission to transform creative ideas into captivating web
                applications. Whether it&apos;s crafting seamless user
                experiences or diving into the backend magic, I thrive on
                ...
                <br />
                <br />
                Join me as I embark on this exciting coding adventure – where
                every line of code tells a story. Let&apos;s build something
