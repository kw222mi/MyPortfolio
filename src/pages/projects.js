...
const Project = ({title, type, img, link, github}) => {
    ...
    return (
      <article
        ...
        border-solid border-dark bg-light dark:bg-dark dark:border-light p-6 relative"
      >
        <div className="absolute top-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[1.5rem] bg-dark rounded-br-3xl dark:bg-light"></div>
        <Link
          href={link}
          target="_blank"
